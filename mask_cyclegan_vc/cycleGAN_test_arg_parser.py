...
class CycleGANTestArgParser(BaseArgParser):
    ...
    def __init__(self):
        ...
        self.parser.add_argument(
            '--preprocessed_data_dir', type=str, default="D:/FYP/MCGAN/preprocessed", help='Directory containing preprocessed dataset files.')
        self.parser.add_argument(
            '--ckpt_dir', type=str, default="D:/FYP/MCGAN/results/debug/ckpts", help='Path to model ckpt.')
        self.parser.add_argument(
